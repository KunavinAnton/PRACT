...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks, TimePickerFragment.Callbacks {
    ...
    private fun updateUI() {
        ...
        timeButton.text = SimpleDateFormat("hh:mm a").format(crime.date)
    ...
    override fun onStart() {
        ...
        reportButton.setOnClickListener {
            ...
            }.also { intent -> val chooserIntent = Intent.createChooser(intent, getString(R.string.send_report))
        ...
        photoButton.apply {
            ...
            setOnClickListener {
                ...
                val cameraActivities:
                        List<ResolveInfo> = packageManager.queryIntentActivities(captureImage, PackageManager.MATCH_DEFAULT_ONLY)
